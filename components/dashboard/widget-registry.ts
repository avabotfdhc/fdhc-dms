...
export const ALL_WIDGETS: Omit<WidgetDefinition, 'component'>[] = [
  ...
  { id: 'calendar',          label: 'Calendar',          description: 'Monthly calendar with follow-up events' },
...
export const DEFAULT_LAYOUT: WidgetConfig[] = [
  ...
  { id: 'calendar',          label: 'Calendar',          description: 'Monthly calendar with follow-up events',           enabled: true  },
